...
//
//    mapping(uint256 => mapping(address => bool)) public hasVoted;
//    mapping(uint256 => mapping(uint256 => uint256)) public votes; // pollId => candidateId => voteCount
//
//    event VoteCast(uint256 indexed pollId, address indexed voter, uint256 candidateId);
//
//    constructor(address _voterRegistry, address _poll) {
//        voterRegistry = VoterRegistry(_voterRegistry);
//        poll = Poll(_poll);
//    }
//
...
//        require(!hasVoted[_pollId][msg.sender], "Voter has already voted in this election");
//
//        hasVoted[_pollId][msg.sender] = true;
//        candidates[_pollId][_candidateId].voteCount++;
//
//        int256 voterZone = voterRegistry.identityRegistry().getVoterZone(msg.sender);
//        electionResults[_pollId].votesByZone[voterZone]++;
//        electionResults[_pollId].totalVotes++;
//
//        emit VoteCast(_pollId, msg.sender);
...
//        return votes[_pollId][_candidateId];
//    }
//}
