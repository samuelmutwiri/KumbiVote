...
const NavBar = () => {
  ...
  return (
    <header className="fixed inset-x-0 xs:w-[95%] sm:w-[90%] md:w-[80%] mx-auto top-0 z-50 bg-gradient-to-r from-white/10 to-white/60 backdrop-blur-sm mb-4">
      <nav
        aria-label="Global"
...
export const navigation = [
  ...
  },
  {
    title: "Vote",
    href: "/vote",
    cname: " text-white bg-blue-600 py-1.5 px-4 rounded font-bold w-full",
  },
];
